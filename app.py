...
# Sidebar formation for navigstion
with st.sidebar:
...
if selected == 'Heart Disease Prediction':
    ...
    mhra     = col2.slider('Maximum Heart Rate Achieved',20,500,80)
...
#mapping for catagorical Data
    ...
    if(st.button('Heart Disease Test Result')):
        ...
        heart_diagnosis = 'The Person is having Heart Disease' if pred == 1 else 'The Person is not does not having Heart Disease'
